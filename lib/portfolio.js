...
export async function createAsset(data) {
  ...
  await ensureSchema(sql);
  const rows = await sql`
    INSERT INTO assets (name, asset_type, country, capacity_mw, capacity_mwh, commissioning_date, status, metadata)
    VALUES (
      ${data.name}, ${data.asset_type}, ${data.country.toUpperCase()}, ${data.capacity_mw},
