...
export function berlinDateToUTC(dateStr) {
  return berlinDateTimeToUTC(`${dateStr}T00:00`);
}

// "YYYY-MM-DDTHH:mm" (valeur d'un <input type="datetime-local">) interprété
// comme une heure de Berlin -> instant UTC correspondant.
export function berlinDateTimeToUTC(dateTimeStr) {
